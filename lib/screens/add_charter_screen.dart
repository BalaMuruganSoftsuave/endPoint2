...
import 'package:endpoint2/widget/textFieldWidget.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';
import 'package:provider/provider.dart';

import '../helper/appStyle.dart';
...
ValueNotifier<Country> country=ValueNotifier(Country(
  ...
  Widget build(BuildContext context) {
                            ...
                            children: [
                              InkWell(
                                  ...
                                  child: Padding(
                                    ...
                                    child: SvgPicture.asset("assets/images/back.svg",
                                      color: isDarkMode.value?AppColor.appWhiteDark:AppColor.appBlack,),
                                  )),
                              const SizedBox(
                                height: 15,
                              ),
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  onTap: ()
                                  {
                                    countryPicker(context,phone: false,isDark: isDark);
                                  },
                                    ...
                                    builder: (context,Country name,child) {
                                      return Container(
                                        ...
                                        decoration: BoxDecoration(
                                            color: isDark?AppColor.textFieldBackgroundDark:AppColor.textFieldBackground,
                                            borderRadius: BorderRadius.circular(10)),
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          children: [
                                            Text(
                                              name.name.isNotEmpty?name.name:"Country of residence",
                                              style:
                                                  AppStyle.notaSubText(color: AppColor.textGrey2),
                                            ),
                                ...
                                child: Row(
                                  children: [
                                    Expanded(
                                      ...
                                      child: InkWell(
                                        onTap: (){
                                          countryPicker(context,phone: true,isDark: isDark);
                                        },
                                        child: ValueListenableBuilder(
                                          valueListenable: countryCode,
                                          builder: (context,Country code,child) {
                                            return Container(
                                              padding: const EdgeInsets.only(
                                                  top: 17, bottom: 17, left: 12, right: 12),
                                              decoration: BoxDecoration(
                                              ...
                                              child: Row(
                                                children: [
                                                  code.phoneCode.isNotEmpty?Container(
                                                    decoration: BoxDecoration(
                                                      borderRadius: BorderRadius.circular(30),
                                                    ),

                                                      child: Text(code.flagEmoji)): SvgPicture.asset('assets/images/united kingdom.svg'),
                                                  Text(code.phoneCode.isNotEmpty?" + ${code.phoneCode}":" +44",
                                                  style: TextStyle(
                                ...
                                child: Row(
                                  children: [
                                    Text('Want to search again? ',
                                        style:
                                        AppStyle.notaSubText(color: AppColor.textGreyDark3)),
                                    InkWell(
                                      onTap: () {
                                      ...
                                      child: Text(
                                        'Click here',
                                        style: AppStyle.notaSubText(color: AppColor.appBlue),
                                      ),
                                    ),
                                  ],
                                ),
                                ...
                                onTap: ()async{
                                 await _formKey.currentState?.validate();
                                  ...
                                  city.text.isNotEmpty){
                                    ...
                                    var res = await context.read<CharterCubit>().addCharter(
                                        name.text,
                                        email.text,
                                        address.text,
                                    ...
                                    if(res is String) {
                                      ...
                                      customToast(context,status: "Error",message: "Entered Detailed is wrong, please try again ");

                                    }
                                      else {
                                      circleProgress.value=false;
                                      customToast(context,status: "Success",message: "Successfully Created");
                                    }
                                  }
   ...
   countryPicker(BuildContext context, {required bool phone,bool isDark=false}){
     showCountryPicker(
      context: context,
      showPhoneCode: phone,
