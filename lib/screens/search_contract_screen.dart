                                  ...
                                  return Container(
                                    ...
                                    child: Card(
                                      shape: RoundedRectangleBorder(
                                          borderRadius:
                                              BorderRadius.circular(10)),
                                      child: state.charterList == null ||
                                              state.charterList?.data == null
                                          ? Center(
                                              child: state.charterReqState !=
                                                      CharterReqState.LOADING
                                                  ? Text(
